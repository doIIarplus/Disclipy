...
autopep8 --in-place --recursive --max-line-length 90 --aggressive --aggressive --ignore=E711,E713,E714 -v src/
autopep8 --in-place --max-line-length 90 --aggressive --aggressive --ignore=E711,E713,E714 -v *.py
